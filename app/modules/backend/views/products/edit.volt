...
<section class="content-header clearfix">
    <h1 class="pull-left">Редактировать товар</h1>
</section>
<section class="content">
    {{ form('products/edit/'~product.id, 'enctype' : 'multipart/form-data') }}
        <div class="row">
            <div class="col-sm-8">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="attribute-list">
                            {% for attribute in product.Attributes %}
                                <div class="form-group" data-attribute="{{ attribute.attribute_id }}">
                                    <div class="input-group">
                                        <div class="input-group-addon">{{ attribute.Attribute.attribute }}</div>
                                        <input type="text" name="attribute[{{ attribute.attribute_id }}]" value="{{ attribute.value }}" class="form-control" />
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-danger delete-attribute" data-attribute="{{ attribute.attribute_id }}"><i class="fa fa-close"></i></button>
                                        </div>
                                    </div>
                                </div>
                            {% endfor %}
